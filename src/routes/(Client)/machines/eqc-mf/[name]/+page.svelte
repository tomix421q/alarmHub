...
<main class="lg:max-w-8xl mt-6 grid justify-center gap-6 md:mt-12 lg:grid-cols-4">
	<!-- HMI -->
	<section
		class="glass-effect relative flex w-full flex-col rounded-lg border md:min-h-[500px] lg:col-span-3 lg:p-3"
	>
		<Header text="Hmi Live Alerts" classNameh1="!w-fit" />
		{#if loading}
			<span
				class="bg-muted-foreground text-primary flex !min-h-[15.625rem] animate-pulse flex-col items-center justify-center rounded-lg text-lg font-semibold uppercase md:text-2xl"
		...
		{:else if !WSserverAlertsStatus?.isConnected}
			<span
				class="bg-destructive text-primary flex h-auto !min-h-[15.625rem] animate-pulse flex-col items-center justify-center rounded-lg text-lg font-semibold uppercase md:text-2xl"
	...
	<!-- STATE ZONE -->
	<section
		class="glass-effect flex max-h-[37.5rem] w-full flex-col rounded-lg border p-3 shadow-2xl lg:col-span-1"
	>
	...
	<!-- CHART ZONE -->
	<section
		class="glass-effect flex max-h-[37.5rem] w-full flex-col rounded-lg border p-3 shadow-2xl lg:col-span-3 lg:max-w-6xl"
	>
	...
	<!-- PRODUCTION DATA -->
	<section
		class="glass-effect flex max-h-[500px] w-full flex-col rounded-lg border p-3 shadow-2xl lg:col-span-1"
	>
	...
	<!-- NOTE ZONE -->
	<section class="glass-effect flex w-full flex-col rounded-lg border p-3 shadow-2xl lg:col-span-4">
